...
class MCT(nn.Module):
    def __init__(self,
        ...
        if dataset == 'Pavia':
            ...
            u2_channel = n_bands * 3
        self.U1 = nn.Sequential(
            # nn.Conv2d(n_bands * 3 - 2, n_bands*2, kernel_size=3, stride=1, padding=1),
            nn.Conv2d(n_bands * 3 , n_bands * 2, kernel_size=3, stride=1, padding=1),
            nn.ReLU(),
        ...
        self.U2 = nn.Sequential(
            nn.Conv2d( n_bands * 2, n_bands, kernel_size=3, stride=1, padding=1),
            nn.ReLU(),
