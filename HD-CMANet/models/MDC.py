from models.TransformerMDC import TransformerModel
...
class MDC(nn.Module):
    def __init__(self,
        ...
        if dataset == 'PaviaU' or dataset == 'Washington' or dataset == 'Botswana':
        ...
        elif dataset == 'Houston_HSI' or dataset =='Botswana' or dataset =='salinas_corrected':
